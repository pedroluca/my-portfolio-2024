...
import Mouse1 from '@/images/setup-images/mouse.webp'
...
import Essencialismo from '@/images/setup-images/essencialismo.webp'
...
export type ImageMapKeys =
  ...
  | 'spotify' | 'googleDrive' | 'github' | 'smartphone2' | 'essencialismo'
