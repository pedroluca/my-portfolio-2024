        ...
        <nav id='navbar' className={
          ...
          <div className='py-4 px-5 bg-zinc-950 w-72 flex flex-col border-l lg:border-0 border-white/20 lg:flex-row lg:items-center lg:w-auto lg:p-0 lg:bg-transparent'>
            ...
            <ul className='flex flex-col gap-2 px-1 mt-4 text-lg lg:flex-row lg:items-center lg:mt-0'>
              <li>
                <button onClick={() => handleNavLinkClick('about-section')} className='text-zinc-400 font-semibold lg:hover:bg-white/20 transition px-2 py-1 lg:rounded-md w-full text-left'>
                  Sobre
                </button>
              </li>
              <li>
                <button onClick={() => handleNavLinkClick('projects-section')} className='text-zinc-400 font-semibold lg:hover:bg-white/20 transition px-2 py-1 lg:rounded-md w-full text-left'>
                  Projetos
                </button>
              </li>
              <li>
