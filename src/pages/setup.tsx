          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-3 gap-6'>
            {loading ? (
              ...
              <>
                ...
                <SetupCard theme={theme} src='mouse1' itemType='App-Tech MWR560' itemName='Mouse' url='https://pt.aliexpress.com/item/1005005847298347.html?spm=a2g0o.order_list.order_list_main.6.649ecaa4iWc5Ig&gatewayAdapt=glo2bra' />
